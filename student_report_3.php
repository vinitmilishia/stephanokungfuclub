                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        ...
                        <?php
                            ...
                            $c->sql="select student.*,rank.rank_belt_color,user.user_type from student inner join rank on student.stud_rank_id=rank.rank_id inner join user on student.stud_user_id=user.user_id where stud_rank_id='".$_POST['rank_id']."' order by stud_id";
                            $c->getdata($c->sql);
